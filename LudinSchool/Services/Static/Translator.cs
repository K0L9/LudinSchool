...
namespace LudinSchool.Services.Static.Translit
{
    public class TranslitMethods
    {
        public class Translitter
        {
            ...
            public Translitter()
            {
                ...
                var gost = "а:a,б:b,в:v,г:g,д:d,е:e,ё:jo,ж:zh,з:z,и:i,й:jj,і:i,ї:ui,к:k,л:l,м:m,н:n,о:o,п:p,р:r,с:s,т:t,у:u,ф:f,х:kh,ц:c,ч:ch,ш:sh,щ:shh,ъ:,ы:y,ь:,э:eh,ю:ju,я:ja";
                var iso = "а:a,б:b,в:v,г:g,д:d,е:e,ё:yo,ж:zh,з:z,и:i,й:j,і:i,ї:ui,к:k,л:l,м:m,н:n,о:o,п:p,р:r,с:s,т:t,у:u,ф:f,х:h,ц:c,ч:ch,ш:sh,щ:shh,ы:y,ь:,ъ:,э:e,ю:yu,я:ya";
